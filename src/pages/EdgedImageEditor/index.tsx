...
const EdgedImageEditor = () => {
    ...
    // w-[48rem] h-[54rem] pl-5 pr-6 pt-6 pb-6
    const imageEditorZone = (
        <>
        {edgeImageState?.edgeImage && (
        <div className="w-[44rem] h-[50rem] px-6 py-8">
    ...
    return (
        <div className="flex flex-col items-center justify-center mt-7" 
            ...
            <div className="flex flex-col items-center justify-center m-5" >
                ...
                {edgeImageState?.edgeImage && (
                    <>
                    <div className="w-[44rem] h-[49rem] flex flex-col items-center justify-center bg-yellow-200 
